        ...
        <div className="row m-0 h-100">
          <div className="col-12 col-sm-7 col-md-8 col-lg-9 p-0">
            <div className="content-left h-100vh p-3 dashboard-content-left">
              ...
              <div
                className="header d-flex align-items-center justify-content-between pb-1 mb-4"
              >
              ...
              <div className="row m-0">
                <div className="col-12 col-lg-6 p-0 pe-0 pe-lg-2">
                  <h6 className="text-uppercase sec-clr mb-1">ASSETS OVERVIEW</h6>
              
                  <div className="px-2 dashboard-card mb-2 mb-lg-3">
                    <div className="row m-0">
                      <div
                        className="col-2 d-flex align-items-center justify-content-center p-0 py-3"
                      >
                        <img
                          src="/balance.PNG"
                          alt="..."
                      ...
                      <div
                        className="col-5 d-flex flex-column align-items-start justify-content-between px-2 py-3 bx-shdw"
                      >
                  ...
                  <div className="px-2 dashboard-card">
                    <div className="row m-0">
                      ...
                      <div
                        className="col-5 d-flex flex-column align-items-start justify-content-between px-2 py-3"
                      >
                        <div className="dets-in-labl-val d-flex flex-column mb-3">
                          <span className="black-clr fs-11">
                            Total Rent Earned
                        ...
                        <div className="dets-in-labl-val d-flex flex-column">
                          <span className="black-clr fs-11"> Rent Balance </span>
                          <span className="black-clr fw-500"> $0.00 </span>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        <div className="dets-in-labl-val d-flex flex-column">
                          ...
                          <span
                            className="black-clr fw-500 d-flex align-items-center"
                          >
                            $0.00
                            <div
                              className="property-indicator increased-percent d-flex align-items-center ms-1"
                            >
                              <span className="text-danger fs-10"> 0% </span>
                              <i
                                className="fa fa-arrow-down text-danger ms-1 fs-10"
                              ></i>
                            </div>
                          </span>
                        </div>
                ...
                <div className="col-12 col-lg-6 p-0 ps-0 ps-lg-2">
                  ...
                  <div className="px-2 dashboard-card">
                    <div className="row m-0">
                      <div
                        className="col-2 d-flex flex-column align-items-center justify-content-center p-0 py-3"
                      >
                        <img
                          src="/balance.PNG"
                          alt="..."
                      ...
                      <div className="col-6 p-0 pb-3 pe-1">
                        <div className="graph p-2">
                          <div
                            className="dets-in-labl-val d-flex flex-column mb-3 w-100"
                          >
              ...
              <div className="transactions-list-data mt-4">
                <div
                  className="list-hdr d-flex flex-row align-items-center justify-content-between mb-1"
                >
                ...
                <div className="transactions-list">
                  <ul className="list-group list-group-horizontal-md mb-1">
                    ...
                    <li className="list-group-item flex-fill">Transaction Name</li>
                    <li className="list-group-item flex-fill">Mm/dd/yyyy Hh:Mm</li>
                    <li className="list-group-item flex-fill">Reference Number</li>
          ...
          <div className="col-12 col-sm-5 col-md-4 col-lg-3 p-0">
            <div className="content-right h-100 p-3 ps-2">
              ...
              <div
                className="notification-details d-flex align-items-center justify-content-between mb-4"
              >
                <div className="notifications-left">
                  ...
                  <span className="badge bg-white black-clr p-2 ms-1">
                ...
                <div className="notifications-right">
                  <span className="badge bg-white black-clr p-2">
                    <i className="fa fa-square-o black-clr" aria-hidden="true"></i>
                  </span>
                  <span
                    className="badge bg-white black-clr p-2 position-relative ms-1"
                  >
                    <i className="fa fa-bell-o black-clr" aria-hidden="true"></i>
                    <span
              ...
              <div className="my-properties-data">
                ...
                <ul className="list-group">
                  <li className="list-group-item border-0 p-2 mb-1">
                    <div className="row m-0">
                      ...
                      <div
                        className="col-8 p-0 d-flex flex-column justify-content-between"
                      >
                      ...
                      <div className="col-6 p-0 minimum-value-data">
                        <div className="content-left d-flex align-items-center">
                          <div className="d-flex flex-column pri-clr me-1">
                            <span className="fs-13 fw-500 min-val"> $52.86 </span>
                            <span className="fs-10 fw-500 lh-10 min-txt">
                              MINIMUM
                            </span>
                          </div>
                          <div
                            className="d-flex align-items-center p-1 success-percent-data"
                          >
                            <i
                              className="fa fa-arrow-up text-success me-1 fs-10"
                            ></i>
                      ...
                      <div className="col-6 p-0 tokens-data">
                        <div
                          className="content-right d-flex align-items-center justify-content-end bg-white"
                        >
                          <div
                            className="d-flex flex-column align-items-end sec-clr me-1"
                          >
                            <span className="fs-13 fw-500 black-clr tokens-val">
                              5,636
                            </span>
                            <span
                              className="fs-10 fw-500 text-end sec-clr lh-10 tokens-txt"
                            >
                              TOKENS LEFT
                            </span>
                          </div>
                        ...
                        <div className="content-left d-flex align-items-center">
                          ...
                          >
                            <i
                              className="fa fa-arrow-up text-success me-1 fs-10"
                            ></i>
                            <span className="text-success fs-10"> 6.36% </span>
                          </div>
                        </div>
                      </div>
                      <div className="col-6 p-0 tokens-data">
                ...
                <div className="refer-earn-info">
                  <div className="row m-0">
                    <div
                      className="col-3 col-lg-2 d-flex align-items-center justify-content-center p-0 pe-1"
                    >
                      <img
                        src="/bonus.PNG"
                        alt="..."
                    ...
                    <div
                      className="col-9 col-lg-10 d-flex flex-column align-items-start p-0"
                    >
                      <h6 className="mb-0 pri-clr fs-13 fw-bold">Refer & Earn</h6>
